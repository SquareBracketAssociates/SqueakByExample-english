...
\begin{figure}[ht]\centering
	...
	\caption{The Monticello Browser.\label{fig:monticelloMain}}
\end{figure}
...
If you want to save your code in a SqueakSource Monticello repository, the project security policy should allow you to do so. We will come back on that point later in \secref{monti:squeaksource} in this chapter.
...
Your package may be merged with another version by using the \emph{Merge} button in the Monticello browser. We will come back on the different options available at that stage. Press \emph{Merge} to replace your package with a new version of this one. Note that your change, if any, will be erased.
...
\section{SqueakSource} \seclabel{monti:squeaksource}

Modifying a package with the system code browser makes this package \emph{dirty}, meaning that you produced a delta with the last version that has been saved or loaded. A dirty package has its name prepended with the \emph{*} character in the Monticello browser.

%=================================================================

\section{Operations} \seclabel{monti:squeaksource}

\subsection{Merging}

Replacing a package with a new version. When are my local changes erased?
