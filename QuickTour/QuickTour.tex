...
In \figref{download}, we see that we have grabbed the \textit{Squeak3.9-final-7067} image and changes files.\footnote{In this book we assume that this is the image you are using. Other images might differ slightly from the descriptions in this book.}
\end{enumerate}

\dothis{Download and install \sq on your computer.}
\index{download}

The version of \sq that we have used for developing the examples in this book is \emphind{Squeak-dev}, available from \url{http://damien.cassou.free.fr/squeak-dev.html}.
\label{sec:squeakDev}
