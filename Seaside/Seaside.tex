...
\dothis{Define \ct{MyCalculator} to be a root component and register itself as an application.
Implement \ct{MyCalculator>>>renderContentOn:} to render something trivial, and verify that the application runs in a browser.
}
...
\begin{code}{}
MyKeypad>>>MyKeypad>>>renderContentOn: html 
