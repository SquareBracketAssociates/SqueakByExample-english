...
\alex{I would stress that toggleValue has to be a class attribute  \ab{Do you mean instance variable?}. It cannot be a temporary variable (method or block)}

\ab{I have to say that \ct{toggleValue} is a pretty poor name for an instance variable.}
